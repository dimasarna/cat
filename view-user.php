...
<html lang="id">
	<head>
		...
		<title>Scoreboard - Insan Penjaga Al-Qur'an</title>
		      ...
		      <ul class="nav navbar-nav">
		        ...
		        <li class="dropdown">
		          ...
		          <ul class="dropdown-menu">
		            ...
		            <li class="active"><a href="view-user.php">Scoreboard</a></li>
		          </ul>
		        </li>
		        <li class="dropdown">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					while ($data = mysqli_fetch_array($query)) {
						...
						echo "<td><a href='edit-user.php?id=" . $data["id"] . "'>Edit</a> | <a href='delete-user.php?id=" . $data["id"] . "'>Delete</a></td>";
						echo "</tr>";
